...
public class RecommendUtils {
         ...
         *
         * @param x 用户对各景点的收藏情况数组
         * @param y 另一用户对各景点的收藏情况数组
         * @return 返回皮尔逊相关系数
         */
...
//      返回皮尔逊相关系数
         ...
         * @param userRatings 用户收藏行为矩阵 行表示用户 列表示景点（收藏情况）
         * @param k           返回的最相似用户数量
         * @return 返回最相似的K个用户数组
         */
...
//      返回最相似的K个用户数组
         ...
         * @param userRatings 用户收藏矩阵 行表示用户 列表示景点收藏情况
         * @param k           推荐物品的数量
         * @return
         */
...
//              已经返回所需要的数量->结束
    ...
    public static void main(String[] args) {
        ...
        RecommendUtils.recommendItems(0, userRatings, 3);
